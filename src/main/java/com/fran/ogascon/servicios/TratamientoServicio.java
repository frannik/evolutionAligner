...
public class TratamientoServicio {
    ...
    @Transactional
    public Tratamiento crearTratamiento (String idPaciente, List<Patologia> patologias, String idUsuario, TipoTratamiento tipoTratamiento, 
                                                    boolean aceptar) throws MiException{
        
        validarTratamiento(idPaciente, idUsuario, patologias, tipoTratamiento, aceptar);
        Paciente p = pacienteRepositorio.findById(idPaciente).get();
        Usuario u = usuarioRepositorio.findById(idUsuario).get();
        Tratamiento t = new Tratamiento();
        t.setPatologias(patologias);
    ...
    // El metodo a conticuacion, sirve para buscar un Tratamiento por un Id que viene de Interf Graf.
    public Tratamiento getOne(String id){ 
        return tratamientoRepositorio.getOne(id);
    }
    ...
    private void validarTratamiento(String idPaciente, String idUsuario, List<Patologia> patologias, TipoTratamiento tipoTratamiento, boolean aceptar) throws MiException {
